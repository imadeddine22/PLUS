                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <Card className="bg-amber-50 border-amber-200">
                        <div className="flex items-start space-x-4">
                            ...
                            <div>
                                <h4 className="font-semibold text-amber-900 mb-1">Note importante</h4>
                                <p className="text-sm text-amber-800">
                                    PULSE n'est pas une compagnie d'assurance. Nous agissons en tant que courtier technologique intermédiaire pour faciliter votre souscription et la gestion de vos contrats.
                                </p>
                            </div>
                        </div>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-br from-pulse-accent/5 to-pulse-accent/10 border-pulse-accent/30 text-center p-8 sm:p-12">
                        ...
                        <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                            Cette démo vous a présenté les principes de l'assurance adaptative. Pour en savoir plus sur nos partenaires et nos offres réelles, contactez-nous.
                        </p>
                        <a
                            href="#hero"
